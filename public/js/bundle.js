...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_App2.default, { player: player }), document.getElementById('react-root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    key: 'swapCard',
	    value: function swapCard(cardId) {
	    ...
	    key: 'cancelCard',
	    value: function cancelCard(cardId) {
	      this.setState({
	        swapping: false,
	        adding: null
	      });
	    ...
	    value: function render() {
	      ...
	      if (this.state.connected) {
	        var _ret = function () {
	          var self = _this2;
	          var sprintCards = _this2.state.game.cards.filter(inSprint).map(function (card) {
	            return _react2.default.createElement(_SprintCard2.default, {
	              key: card.id,
	              ...
	              turn: turn(_this2.state, _this2.props.player)
	            });
	          });
	          var freeCards = _this2.state.game.cards.filter(notInSprint).map(function (card) {
	          ...
	          var classes = "header " + _this2.props.player;
	          var pass = turn(_this2.state, _this2.props.player) ? _react2.default.createElement(
	            'div',
	            { className: 'header-action', onClick: _this2.pass.bind(_this2) },
	            'Pass'
	          ) : null;
	          var space = _this2.state.game.currentWeight + '/' + _this2.state.game.maxWeight;
	          return {
	            v: _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(_Phase2.default, { state: _this2.state, player: _this2.props.player }),
	                pass,
	                _react2.default.createElement(
	                  'div',
	              ...
	              _react2.default.createElement(_Players2.default, { state: _this2.state, player: _this2.props.player }),
	              _react2.default.createElement(
	                'section',
	                { className: 'sprint' },
	                _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	function addable(props) {
	  if (props.game.phase < 3) return !props.swapping && props.turn;else return !props.swapping && props.turn && props.game.currentWeight + props.game.cards[props.cardId].weight <= props.game.maxWeight;
	} /* React */
	...
	function Card(props) {
	  var button = addable(props) ? _react2.default.createElement(
	    "div",
	    { className: "card-action", onClick: function onClick() {
	        return props.add(props.cardId);
	      } },
	    "Add"
	  ) : null;
	  var cancelButton = cancelable(props) ? _react2.default.createElement(
	    "div",
	    { className: "card-action", onClick: function onClick() {
	        return props.cancel(props.cardId);
	      } },
	    "Cancel"
	  ) : null;
	  return _react2.default.createElement(
